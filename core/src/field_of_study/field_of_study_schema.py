...
class FieldOfStudySchema(BaseModel):
    ...
    title_short: str = Field(..., description="Field of Study short title", max_length=5)
...
class FieldOfStudyUpdateSchema(BaseModel):
    ...
    title_short: Optional[str] = Field(None, description="Field of Study short title", max_length=5)
